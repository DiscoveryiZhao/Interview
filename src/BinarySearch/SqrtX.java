...
public class SqrtX {
    ...
    public static int mySqrt(int x) {
        ...
        while (low + precision < high) {
            ...
            int midSqr = mid;
            if(midSqr == x/mid) return mid; //we find the exact sqrt value!
            else if(midSqr < x/mid) low = mid; //we shift our focus to bigger half
            else high = mid; //shift focus to smaller half
        }
