...
public class MaxPointsOnALine {
    ...
    public static int maxPoints(Point[] points) {
        ...
        if (n == 0) {
            ...
            HashMap<Double, Integer> map = new HashMap<Double, Integer>(); // new HashMap<slope, pointsCount>
    ...
    public static void addPoint(HashMap<Double, Integer> map, double slope) {
